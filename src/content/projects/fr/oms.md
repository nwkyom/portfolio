---
title: OMS (Overland Micro-Services)
...
- Traitement d'images satellite (suppression des nuages)
- Architecture microservices Java et Python sur GCP
- Orchestration Kubernetes et Terraform
